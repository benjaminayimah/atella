<template>
    <header>
        <div id="top_header" class="flx">
            <div class="flx gap-8 ai-c">
                <span>Atella 2023 season</span>
        ...
        <nav>
            <div class="nav-wrapper grid grid-col-3 ai-c">
                ...
                <div class="txt-a-r">
                    <a href="#" class="a-btn button-primary br-32 btn-lng">Configure</a>
                </div>
